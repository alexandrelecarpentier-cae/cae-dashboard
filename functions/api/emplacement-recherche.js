// /api/emplacement-recherche?q=<texte> — recherche d'un emplacement par
// nom/ville, pour l'écran de sélection de /emplacement.html.
import { buildRechercheQuery } from '../lib/sql-emplacement.js';
